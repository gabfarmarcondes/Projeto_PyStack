...
def novo_flashcard(request):
    ...
    if request.method == 'GET':
        ...
        if dificuldade_filtrar:
            flashcards = flashcards.filter(dificuldade__id=dificuldade_filtrar)
...
def desafio(request, id):
    ...
    if request.method == 'GET':
        ...
        return render(request, 'desafio.html', {'desafio': desafio, 'acertos': acertos, 'erros': erros, 'faltantes': faltantes, 'categorias_desafio': categorias_desafio, })


def responder_flashcard(request, id):
    flashcard_desafio = FlashcardDesafio.objects.get(id=id)
    acertou = request.GET.get('acertou')
    desafio_id = request.GET.get('desafio.id')
